...
/*Realizza il lock logico senza l'utilizzo del mutex di un capitolo all'interno del file. Chi trova un capitolo bloccato rimane in attesa del segnale di sblocco.*/
struct list_el *lockLogicalWrite_nnomutex(int file, int init , int , regions * , pthread_mutex_t );
