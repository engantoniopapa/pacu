...
int connect_ServerServer(char *ipServer , uint16_t port_server , int n_prove); // Crea la connessione
...
int send_PR_Message(int  , PR_Message* ); //	Invio messaggio PR

int  recv_PR_Message( int , PR_Message* ); // riceve un messaggio di tipo PR
