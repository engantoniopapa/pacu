...
void set_Unit_TH_Pong(Unit_TH_Pong * , int , ListPong *, Two_rooms *, Semaphore * , char * , int ); // setta una struttura di tipo Unit_TH_Pong
...
void *dispSrv_rcvPP_UDP(); //dispatcher UDP per i pacchetti ping-pong provenienti dai client

void *dispCl_rcvPP_UDP(); //dispatcher UDP per i pacchetti ping-pong provenienti dai server
